...
const About = () => {
  return (
    <>
      ...
      >
        As an experienced software developer with expertise in TypeScript,
        JavaScript, and frameworks like React and Node.js, I have the skills to
        create efficient, scalable, and user-friendly solutions that solve
        real-world problems. I am also a quick learner and collaborate closely
        with clients to ensure their ideas are brought to life. Let's work
